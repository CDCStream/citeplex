  ...
  return (
    <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-4">
      <Button
        size="lg"
        variant="outline"
        className="h-12 sm:h-13 w-full sm:w-auto rounded-full border-2 px-8 text-base font-semibold"
        asChild
      >
        <Link href="/login">
      ...
      <Button
        size="lg"
        className="h-12 sm:h-13 w-full sm:w-auto rounded-full bg-linear-to-r from-blue-600 via-blue-500 to-blue-400 px-8 text-base font-semibold text-white shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-shadow"
        asChild
      >
        <Link href="/login">
