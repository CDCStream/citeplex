...
const tiers: PricingTier[] = [
  {
    ...
    monthlyPrice: "0",
    perPrompt: "Free",
    description: "Try Citeplex with no commitment. No credit card required.",
    cta: "Sign Up Free",
    href: "/login",
    background: "",
    free: true,
  ...
  },
  {
    ...
    monthlyPrice: "20",
    perPrompt: "1.33",
    description: "Perfect for freelancers and personal brands getting started with AI visibility.",
    cta: "Get Started",
  ...
  },
  {
    ...
    monthlyPrice: "39",
    perPrompt: "1.30",
    description: "For growing brands that need broader AI search coverage.",
    cta: "Get Started",
  ...
  },
  {
    ...
    monthlyPrice: "59",
    perPrompt: "1.18",
    description: "Most popular plan for businesses serious about AI search dominance.",
    cta: "Get Started",
  ...
  },
  {
    ...
    monthlyPrice: "99",
    perPrompt: "0.99",
    description: "For teams managing multiple domains and competitive markets.",
    cta: "Get Started",
  ...
  },
  {
    ...
    monthlyPrice: "249",
    perPrompt: "1.00",
    description: "Maximum coverage for agencies and large-scale brand monitoring.",
    cta: "Get Started",
